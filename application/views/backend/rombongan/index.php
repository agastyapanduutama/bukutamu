	...
	<div class="box-body row" >
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <div class="col-md-2">
              	  <form action="<?= base_url('administrator/rombongan/pencarian/seluruh_kawasan')?>" method="POST">
				 ...
				 <div class="pull-right">
	               <div class="col-md-2">
                   	<a href="<?= base_url('administrator/rombongan/cetak/seluruh_kawasan')?>" target="_blank" rel="nofollow" class="btn btn-sm btn-primary">Cetak PDF</a>
	                </div>
	            </div>
                </div>
              </div>
