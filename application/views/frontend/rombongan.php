   ...
   <div class="container">        
    ...
    <input type="hidden" value="RMBG<?= $x['no_kunjungan']?>" name="no_kunjungan">    
        ...
        <div class="form-group row">
            <label class="col-md-3 control-label">Nama Ketua Rombongan</label>
            <div class="col-md-5">
         ...
         <div class="form-group row">
            <label class="col-md-3 control-label">Nomor Ketua Rombongan</label>
            <div class="col-md-5">
        ...
        <div class="form-group row">
            <label class="col-md-3 control-label">Nama Instansi Lembaga</label>
            <div class="col-md-5">
        ...
        <div class="form-group row">
            <label class="col-md-3 control-label">Alamat Instansi Lembaga</label>
            <div class="col-md-5">
        ...
        <div class="form-group row">
            <label class="col-md-3 control-label">Nomor Instansi Lembaga</label>
            <div class="col-md-5">
        ...
        <div class="form-group row">
            <label class="col-md-3 control-label">Alamat Email Instansi Lembaga</label>
            <div class="col-md-5">
        ...
        <div class="form-group row">
            <label class="col-md-3 control-label">Jumlah Personil Lembaga</label>
            <div class="col-md-5">
        ...
        <div class="form-group row">
            <label class="col-md-3 control-label">Jenis Layanan yang digunakan</label>
            <div class="col-md-5">
