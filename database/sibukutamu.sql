...
--
-- Host: localhost
-- Generation Time: Apr 21, 2020 at 06:20 AM
...
--
ALTER TABLE `rombongan`
  MODIFY `id_rombongan` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sub_lokasi`
--
ALTER TABLE `sub_lokasi`
  MODIFY `id_sub_lokasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
