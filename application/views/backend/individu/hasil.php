			...
			<div class="box-body row" >
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <div class="col-md-2">
              	  <form action="<?= base_url('administrator/individu/pencarian/'.$this->uri->segment(4))?>" method="POST">
				 ...
				 <div class="pull-right">
	               <div class="col-md-2">
                   	  <form action="<?= base_url('administrator/individu/pencarian/cetak/'.$this->uri->segment(4))?>" method="POST">
