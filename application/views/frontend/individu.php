        ...
        <input type="hidden" value="INDV<?= $x['no_kunjungan']?>" name="no_kunjungan">
            ...
            <div class="container">                
               <div class="form-group row">
                        <label class="col-md-3 control-label">Status Keanggotaan</label>
                        <div class="col-sm-7">
                ...
                <div class="form-group row">
                    <label class="col-md-3 control-label">Nama Pengunjung</label>
                    <div class="col-md-5">
                ...
                <div class="form-group row">
                        <label class="col-md-3 control-label">Pendidikan Terkahir</label>
                        <div class="col-sm-7">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    <label class="col-md-3 control-label">Alamat Instansi</label>
                    <div class="col-md-5">
